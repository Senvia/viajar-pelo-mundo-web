            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start md:items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <a 
                    ...
                    className="text-muted-foreground hover:text-primary block break-all md:break-normal text-sm md:text-base"
                  >
              ...
              <div className="flex items-start md:items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center flex-shrink-0 overflow-hidden">
                  <img src="/instagram-icon.png" alt="Instagram" className="w-9 h-9 object-cover scale-125" />
                </div>
                <div className="flex-1">
