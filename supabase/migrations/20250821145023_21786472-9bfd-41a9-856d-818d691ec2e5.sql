...
INSERT INTO public.packages (id, name, description, destination, duration, price, price_note, hero_image, main_image, highlights) VALUES 
(
    'portugal-essence'::uuid,
    'Portugal Essence',
...
('portugal-essence'::uuid, 'City Tour pelo Porto', 'Explore os principais pontos turísticos do Porto com guia especializado', '/lovable-uploads/78890d5a-286d-4b4f-b8a4-a5d44461d3d4.png', 1),
('portugal-essence'::uuid, 'Experiência Vinícola', 'Degustação de vinhos e visita às caves do Porto', '/lovable-uploads/2da541d5-fe43-4e23-bf3e-d0a2793efe31.png', 2),
('portugal-essence'::uuid, 'Workshop Gastronômico', 'Aprenda a fazer os famosos Pastéis de Nata', '/lovable-uploads/00cb83f8-4b51-4af0-9af8-9ccbcd3b0df3.png', 3),
('portugal-essence'::uuid, 'Cruzeiro ao Pôr do Sol', 'Navegue pelo Rio Douro durante o pôr do sol', '/lovable-uploads/604537d9-c3eb-430c-9d01-820b1bec9336.png', 4),
('portugal-essence'::uuid, 'Espetáculo de Fado', 'Noite tradicional com música de Fado autêntica', '/lovable-uploads/5df4c253-f819-4e4f-a21c-a865b6ac3605.png', 5),
('portugal-essence'::uuid, 'Vale do Douro', 'Excursão pelas paisagens vinícolas do Douro', '/lovable-uploads/878dda6e-16ac-446d-bb74-dec63248b020.png', 6);

-- Insert sample experiences for Lisboa Imperial
INSERT INTO public.package_experiences (package_id, title, description, image, order_index) VALUES
('lisboa-imperial'::uuid, 'Bairros Históricos', 'Caminhada pelos bairros históricos de Lisboa', '/lovable-uploads/50a145af-5d83-420a-814c-8f6f70ed394c.png', 1),
('lisboa-imperial'::uuid, 'Mosteiro dos Jerónimos', 'Visita ao icônico mosteiro de Belém', '/lovable-uploads/fda1f478-5e7a-4434-8926-5f0330501e3a.png', 2),
('lisboa-imperial'::uuid, 'Gastronomia em Belém', 'Tour gastronômico pela região de Belém', '/lovable-uploads/00cb83f8-4b51-4af0-9af8-9ccbcd3b0df3.png', 3),
('lisboa-imperial'::uuid, 'Elétrico Tradicional', 'Passeio no famoso elétrico 28 de Lisboa', '/lovable-uploads/5b473dd1-d838-4e32-8cd6-8d66f99b8753.png', 4),
('lisboa-imperial'::uuid, 'Fado em Alfama', 'Noite de Fado no coração de Alfama', '/lovable-uploads/5df4c253-f819-4e4f-a21c-a865b6ac3605.png', 5),
('lisboa-imperial'::uuid, 'Sintra e Cascais', 'Excursão de dia inteiro a Sintra e Cascais', '/lovable-uploads/2da541d5-fe43-4e23-bf3e-d0a2793efe31.png', 6);